...
const icons = [
    {
        uri: '/search',
        icon: (
            <div className="px-4 py-7 transition-all">
                <FaSistrix />
            </div>
        )
    },
            ...
            <div className="relative z-10 flex justify-between items-center sm:flex-nowrap flex-wrap ">
                ...
                <div
                    className={`absolute -z-10 sm:static ${
                        isClose ? '-top-56' : 'top-full'
                    } duration-500 w-full flex items-start sm:justify-between sm:flex-row flex-col sm:items-center bg-slate-400 sm:bg-white`}>
                    <div className="" />
                    ...
                    <div className="iconsNav flex text-2xl">
                        {icons.map(({ uri, icon }) => (
                            <Fragment key={uri}>
